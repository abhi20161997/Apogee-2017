...
class Team(models.Model):
    ...
    members = models.ManyToManyField('registration.Participant')
    leader = models.ForeignKey('registration.Participant', related_name='leader_team')
    event = models.ForeignKey('Event.Event')
    comments = models.CharField(max_length=200, default=None, null=True, blank=True)
    position = models.CharField(max_length=10, blank=True, null=True, default=None)
