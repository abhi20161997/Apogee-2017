lightboxes = [
  ...
  [
    ...
    "<span data-toggle=\"collapse\" data-target=\"#faq7\">7) What will be there for the final round? </span><p id=\"faq7\" class=\"collapse\">A detailed presentation on the final solutions must be given by the selected teams during APOGEE 17. Winning teams will be given either internships or cash prizes.</p>" +
    "<span data-toggle=\"collapse\" data-target=\"#faq8\">8) Are there any participation certificates? </span><p id=\"faq8\" class=\"collapse\">Participation certificates will be given to all the members of each team which present solutions during APOGEE 17.</p>"
  ],
  [
    "Contact Us",
    "<p>Shashwat Shivam Jha<br/>+91-9828626890<br/>shashwat.jh@gmail.com</p>"
  ],
  [
    "Register",
    '<form id="reg-form">\
            ...
            <div class="form-group col-sm-12 col-md-6">\
              ...
              <input type="text" class="form-control" name="gl_name" >\
            </div>\
             <div class="form-group col-sm-12 col-md-6">\
              <label for="gl_phone">Phone</label>\
              <input type="text" class="form-control" name="gl_phone" >\
            </div>\
            <div class="form-group col-sm-12 col-md-6">\
              <label for="gl_email">Email</label>\
              <input type="email" class="form-control" name="gl_email">\
            </div>\
           <div class="form-group col-sm-12 col-md-6">\
              <label for="gl_college">College</label>\
              <input type="text" class="form-control" name="gl_college" >\
            </div>\
             <div class="form-group col-sm-12 col-md-6">\
             <label for="gl_yos">Year Of Study</label>\
              <select class="form-control" name="gl_yos">\
            ...
            <div class="members-wrapper col-sm-12">\
              <p>Members</p>\
              <div class="member-list">\
              <div class="new-member hidden ">\
             \
                <p class="member-number">\
                   <span class="glyphicon glyphicon-minus delete-member" aria-hidden="true"></span>\
                 Member\
           ...
           <div class="form-group col-sm-12 col-md-6">\
             ...
             <label for="yos">Year Of Study</label>\
              ...
              <div class="add-member-wrapper form-button">\
            ...
            <div class="form-group col-sm-12 col-md-6">\
             <label for="problem_statement">Problem </label>\
              <select class="form-control" name="problem_statement">\
               \
                 <option value="Qwikcilver Woohoo">Qwikcilver Woohoo</option>\
                <option value="GE Healthcare">GE Healthcare</option>\
                <option value="Universal Designovation Lab">Universal Designovation Lab</option>\
         ...
         \
             <div class="form-group col-sm-12 reg-submit-wrap">\
              <p class="message"></p>\
              <div class="btn-wrap"> <button type="submit" class="btn btn-default form-button " id="reg-submit">Submit</button></div>\
              </div>\
          </form>'
  ]
];
...
function generateLightbox(index) {
  ...
  content += "<div class='lightbox-content'>"+lightboxes[index][1]+"</div>";
  console.log(content)
  return content;
}
...
function openLightBox(ix) {
  ...
  $(".lightbox .content .container").html(generateLightbox(ix));
